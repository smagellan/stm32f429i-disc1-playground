...
TGT_CFLAGS += -Wall -Wextra -Wshadow -Wno-unused-variable -Wimplicit-function-declaration
...
TGT_CXXFLAGS += -Wall -Wextra -Wshadow -Wredundant-decls  -Weffc++
...
.SUFFIXES:
.SUFFIXES: .c .S .h .o .cpp .hpp .elf .bin .list .lss
